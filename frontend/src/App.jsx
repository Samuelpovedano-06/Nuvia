...
import { Heart, Sparkles, Calendar, User, Home, Flower2, X, Check, Users, MessageCircle } from 'lucide-react';
...
const BottomNav = () => {
  ...
  const navItems = [
    ...
    { label: 'Chats', icon: <MessageCircle size={22} />, path: '/pareja', restricted: false },
