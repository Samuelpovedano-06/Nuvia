    ...
    <div className="screen-container">
      ...
      <div className="card" style={{ padding: '20px', marginBottom: '20px' }}>
        ...
        <div style={{ marginBottom: '15px' }}>
          <label style={{ fontSize: '13px', color: 'var(--text-light)', display: 'block', marginBottom: '6px' }}>Versión del Algoritmo</label>
          <input 
            type="text" 
            value={config.version_algoritmo}
            onChange={e => setConfig({...config, version_algoritmo: e.target.value})}
            style={{ 
              width: '100%', padding: '10px', borderRadius: '10px', border: '1px solid #eee', 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
          <div>
            <label style={{ fontSize: '13px', color: 'var(--text-light)', display: 'block', marginBottom: '6px' }}>Días Min. Ciclo</label>
            <input 
              type="number" 
          ...
          <div>
            <label style={{ fontSize: '13px', color: 'var(--text-light)', display: 'block', marginBottom: '6px' }}>Días Max. Ciclo</label>
            <input 
              type="number" 
